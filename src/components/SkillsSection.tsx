...
const skills = [
  { name: "Python", level: 75, color: "from-[hsl(160,60%,45%)] to-[hsl(180,50%,55%)]" },
  { name: "C", level: 65, color: "from-[hsl(200,60%,50%)] to-[hsl(220,50%,55%)]" },
  { name: "C++", level: 70, color: "from-[hsl(200,60%,50%)] to-[hsl(220,50%,55%)]" },
  { name: "Java", level: 80, color: "from-[hsl(30,80%,50%)] to-[hsl(15,80%,55%)]" },
  ...
  { name: "SQL", level: 70, color: "from-[hsl(280,60%,55%)] to-[hsl(300,50%,50%)]" },
  { name: "React", level: 50, color: "from-[hsl(190,80%,50%)] to-[hsl(200,70%,55%)]" },
  { name: "Next.js", level: 35, color: "from-[hsl(0,0%,60%)] to-[hsl(0,0%,40%)]" },
  { name: "Fast.Api", level: 10, color: "from-[hsl(15,80%,55%)] to-[hsl(25,80%,50%)]" },
  { name: "Django", level: 10, color: "from-[hsl(160,60%,45%)] to-[hsl(180,50%,55%)]" },
];
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex justify-between items-center mb-3">
                  ...
                  <span className="font-heading text-xs text-muted-foreground group-hover:text-primary/70 transition-colors">
                    {skill.level}%
                  </span>
                </div>
