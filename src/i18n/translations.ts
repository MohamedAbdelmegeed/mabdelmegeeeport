...
export const translations = {
  ...
  ar: {
    ...
    about: {
      ...
      title: "عن ",
      titleHighlight: "نفسي",
      p1: "مطور متكامل شغوف بتحويل الأفكار إلى تطبيقات ويب قوية وقابلة للتطوير. بفضل أساس متين في هندسة البرمجيات ومهارات قوية في حل المشكلات وخبرة عملية في Python و JavaScript و C و C ++ و SQL و Git وتقنيات الويب الحديثة، أستمتع ببناء حلول فعالة وموثوقة وموجهة للمستخدم. ملتزم بالتعلم المستمر، وهدفي هو النمو كمهندس برمجيات مع التوسع تدريجياً في علم البيانات والذكاء الاصطناعي للجمع بين تطوير التطبيقات القوي والابتكار الذكي القائم على البيانات.",
      ...
      items: [
        {
          ...
          details: "المستوى الثاني · المعدل التراكمي: 3.2 · القاهرة، مصر",
        },
        {
